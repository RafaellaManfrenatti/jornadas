...
?>
    ...
    <div class="container-fluid text-center conteudo">
      <div class="row">
        ...
        <p><strong>A sua privacidade é importante para nós. É política da plataforma <em>Periféricas</em> respeitar a sua privacidade em relação
    ...
    <h3>Política de Cookies <em>Periféricas</em></h3>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que a plataforma <em>Periféricas</em> oferece no site e com caráter enunciativo, mas não limitativo:</p>
    <ol type="A">
        ...
        <li>Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) da plataforma <em>Periféricas</em>, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer outros sistemas de hardware ou software que sejam capazes de causar danos anteriormente mencionados.</li>
    </ol>

    <h4>Mais informações</h4>
    <p>Esperemos que esteja esclarecido e, como mencionado anteriormente, se houver algo que você não tem certeza se precisa ou não, geralmente é mais seguro deixar os cookies ativados, caso interaja com um dos recursos que você usa em nosso site.</p>
    <p><em>Esta política é efetiva a partir de 28 de Abril 2023 às 18:57.</em></p>
